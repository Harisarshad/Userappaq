...
class AuthRepo extends GetxService {
  ...
  Future<Response> registrationhome(
    Map<String, String> customerInfo,
  ) async {
    return await apiClient.postData(
        AppConstants.CUSTOMER_REGISTRATION_URI, customerInfo);
  }

  Future<Response> registrationCheckCode(
    Map<String, String> customerInfo,
  ) async {
    return await apiClient.postData(
        AppConstants.CUSTOMER_REGISTRATION_CHECK_URI, customerInfo);
  }
  ...
  Future<Response> forgetPassReset(
      {String phoneNumber,
      String otp,
      String password,
