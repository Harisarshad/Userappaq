...
class VerifyPassScreen extends StatefulWidget {
  ...
  const VerifyPassScreen(
      {@required this.qrCode, @required this.phoneNumber, this.signUpBody});
    ...
    return SafeArea(
      child: Screenshot(
        ...
        child: GetBuilder<PassController>(builder: (transactionHistory) {
          ...
          return !transactionHistory.isDetails
                          ...
                          child: Center(
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  margin:
                                      const EdgeInsets.fromLTRB(16, 15, 16, 5),
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                      backgroundColor: Colors.white,
                                      foregroundColor: AqcessColors().primary,
