  ...
  Widget build(BuildContext context) {
    ...
    return CustomInkWell(
      onTap: () => Get.defaultDialog(barrierDismissible: false, title: '4digit_pin'.tr, content: ConfirmPinBottomSheet(
        callBack:   _profileController.twoFactorOnTap, isAuth: isAuth,
      ),),
      child: Padding(
        ...
        child: Row(children: [
          ...
          GetBuilder<AuthController>(builder: (authController) {
              return GetBuilder<ProfileController>(builder: (profController) {
                ...
                bool _isOn = isAuth ? (authController.biometric && authController.biometricPin() != null ) ?? false : profController.userInfo.twoFactor;
